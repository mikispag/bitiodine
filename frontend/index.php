        ...
        <div id="main-content">
            ...
            <main class="nav-animation-element">
                ...
                <section class="show">
                    ...
                    <p>
                        Get <strong>addresses</strong> that sent/received Bitcoin to/from a particular <strong>address</strong>, or find out all the <strong>addresses</strong> likely to be <strong>controlled</strong> by the same <strong>person</strong> or <strong>entity</strong>.
                    </p>

...
function (e, t, n) {
    ...
    function (e, t) {
        ...
        var f = "3.7.0",
            l = e.html5 || {}, c = /^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i,
...
function () {
    ...
    t = {
        ...
        }(this)), c.push(r.src = 'https://bitiodine.net/' + o);
        return c
    }, i = {
...
function () {
    ...
    n = function () {
        ...
        var n;
        return t || (t = window.pixelRatio()), t < 1.5 ? e : e.search("@2x") > -1 ? e : n = e.replace(/\.(jpg|png)/, function (e) {
            return "@" + t + "x" + e
        })
    }, r = function (t, r) {
        var i, s;
...
(function (e) {
    typeof exports == "object" ? module.exports = e() : typeof window.define == "function" && window.define.amd ? window.define([], e) : window.BezierEasing = e()
})(function () {
    function e(t, n, r, i) {
        function o(e, t) {
            return 1 - 3 * t + 3 * e
        ...
        function f(e, t, n) {
            return ((o(t, n) * e + u(t, n)) * e + a(t)) * e
        }

        function l(e, t, n) {
            return 3 * o(t, n) * e * e + 2 * u(t, n) * e + a(t)
        }
        ...
        if (this instanceof e) {
            var h = function (e) {
                return t === n && r === i ? e : f(c(e), n, i)
            }, p = "BezierEasing(" + [t, n, r, i] + ")";
...
function () {
    $(function () {
        var e, t, n, r, i, s, o, u, a, f, l, c, h, p, d, v, m, g, y, b, w, E, S, x, T, N, C, k, L;
        return n = $("header#main-header, footer#main-footer"), n.addClass("load-transition"), L = window.pixelRatio(), b = function (e) {
            return e * L
        }, h = 214, c = 220, u = b(h), o = b(c), e = $("canvas"), s = e.get()[0], a = s.getContext("2d"), i = 1200, l = BezierEasing(0, 0, .58, 1), l = BezierEasing(.25, .1, .25, 1), x = null, m = null, C = null, g = u / 2, y = o / 2, f = function (e, t) {
            var n, r, i, s, a;
            return w(), e.save(), a = -90, n = a + t * 360, e.beginPath(), e.moveTo(g, y), e.arc(g - b(1), y, b(89), a / (180 / Math.PI), n / (180 / Math.PI)), e.clip(), e.drawImage(d.circle, b(18), b(23))
        }, p = function () {
            var e;
            return n.removeClass("load-transition"), e = !1
        }, T = function (e) {
            var t, n;
            return x || (x = e), n = e - x, t = Math.min(n / i, 1), f(a, l(t)), m = e, t < 1 ? window.requestAnimationFrame(T) : p()
        }, w = function () {
            return s.width = u, s.height = o, e.css({
                width: h,
                height: c
            })
        }, w(), E = {
            circle: window.imagePathForRatio("/img/bitcoin/circle.png"),
            fill: window.imagePathForRatio("/img/bitcoin/fill.png"),
        }, d = {}, S = (new Date).getTime(), k = function () {
            var e;
            e = [];
            for (v in E) N = E[v], e.push(N);
            return e
        }(), window.preload(k, function (e) {
            var t;
            for (v in E) N = E[v], d[v] = document.createElement("img"), d[v].src = N;
            return t = (new Date).getTime() - S, setTimeout(function () {
                return $("#bitcoin-logo").addClass("show"), $("main section").addClass("show"), n.addClass("show"), setTimeout(function () {
